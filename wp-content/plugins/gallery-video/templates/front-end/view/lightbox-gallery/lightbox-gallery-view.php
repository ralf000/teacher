<section id="huge_it_videogallery_content_<?php echo $gallery_videoID; ?>" class="gallery-video-content"
    ...
    <div id="huge_it_videogallery_container_<?php echo $gallery_videoID; ?>"
         ...
         data-show-center="<?php echo $gallery_video_get_option['gallery_video_ht_view2_content_in_center_lightbox']; ?>">
    ...
    if ($a == 1) {
        ...
        <div class="load_more4">
            <div class="load_more_button4"
                 data-lightbox-nonce-value="<?php echo $gallery_video_lightbox_nonce; ?>"><?= $gallery_video_get_option['gallery_video_video_ht_view4_loadmore_text']; ?></div>
