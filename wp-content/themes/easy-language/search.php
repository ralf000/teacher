                    ...
                    <article>
                        ...
                        <div class="post-summary">
                            ...
                            <div class="post-summary-footer">
                                <button class="btn btn-small btn-inverse" onclick="location.href='<?php the_permalink()?>'" type="button">Read more</button>
                                <ul class="post-data">
                                    <li><i class="icon-calendar"></i> <?php the_time('d/m/y')?></li>
                                    <li><i class="icon-user"></i> <a href="<?php the_author_link() ?>"><?php the_author()?></a></li>
                                    <li><i class="icon-comment"></i> <a href="<?php comment_link() ?>"><?php comments_number() ?></a></li>
